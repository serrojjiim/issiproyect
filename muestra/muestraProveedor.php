<?php
	...
	if(!isset($_SESSION["cargo"]) or ($_SESSION['cargo']!="CAMIONERO" and $_SESSION['cargo']!="PRESIDENTE" and $_SESSION['cargo']!="VICEPRESIDENTE" and $_SESSION['cargo']!="GERENTECOMPRAS")){
...
<main>
	...
	<div class="selectpag">
		<form class ="formpag" style="display: inline-block" method="get" action="muestraProveedor.php">
		...
		<button style="float:right;" onclick="window.location.href='../modificar/nuevoProveedor.php'" class="anadir">
						...
						<tr class="fila">
							...
							<form action="../controladores/controlador_proveedores.php">
								...
								<td class ="boton">
									...
									onclick="window.location='#popup<?php echo $fila["OID_PROV"]; ?>';" >
									<img src="../img/ocultar.png" class="borrar_fila" alt="Papelera Borrar" height="34" width="34">
								</button></td>
								<div id="popup<?php echo $fila["OID_PROV"]; ?>" class="overlay" align="left">
									<div class="popup">
										<a class="close" href="#">X</a>
										<p class="textp" align="center">¿Seguro que quieres dar de baja al proveedor: <?php echo $fila['NOMBRE'];?>?</p>
									</br>
